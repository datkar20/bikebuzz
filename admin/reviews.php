...
render_header('Danh gia', 'admin-reviews');
?>
<h1 class="page-title h3 mb-3">Quan ly danh gia</h1>
<div class="bb-card p-3 table-responsive">
    <table class="table align-middle mb-0">
        <thead><tr><th>San pham</th><th>Nguoi dung</th><th>So sao</th><th>Noi dung</th><th>Ngay</th><th></th></tr></thead>
        <tbody>
            <?php if (!$reviews): ?>
                <tr><td colspan="6" class="text-center text-muted py-4">Chua co danh gia nao.</td></tr>
            <?php endif; ?>
            <?php foreach ($reviews as $review): ?>
                <tr>
                    ...
                    <td class="text-end">
                        <form method="post" data-confirm="Xoa danh gia nay?">
